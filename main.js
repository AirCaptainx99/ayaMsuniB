...
const { Discord, client, puppeteer, on, fs, http, Imagekit, httpOptions } = require('./files/core_module.js');
const { register } = require('./files/functions/register.js');
const { ping, isNumber, dayOfYear, changePrefix, genshin, getID, initiateNewGuild, schedule, addUserDB } = require('./files/function_lists.js');
                ...
                if ((msg.content.startsWith(prefix) || msg.content.startsWith(globalPrefix)) && !msg.author.bot){
                    ...
                    switch (args[0].toLowerCase()) {
                        ...
                        default:
                            ...
                            async () => {
                                await initiateNewGuild(msg.guild);
                            }
